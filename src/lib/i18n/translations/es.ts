...
const translations: TranslationStructure = {
  ...
  invoices: {
    ...
    settingsForm: {
      ...
      smallBusinessTaxExemption: 'Exención Fiscal para Pequeñas Empresas',
      smallBusinessTaxExemptionDesc: 'Marque esto si califica para la exención fiscal de pequeñas empresas en su país (ej. Kleinunternehmerregelung en Alemania, Régimen Simplificado en España). Esto agregará el texto legal requerido a sus facturas.',
      paymentAndInvoice: 'Configuración de Pago y Factura',
      paymentTermsDays: 'Términos de Pago (Días)',
      paymentTermsDaysDesc: 'Número de días para los términos de pago (predeterminado: 14 días)',
      invoiceNumberPrefix: 'Prefijo de Número de Factura',
      invoiceNumberPrefixPlaceholder: 'ej. FACT-2024-',
      invoiceNumberPrefixDesc: 'Prefijo opcional para sus números de factura (ej. FACT-2024-001)',
      businessSignature: 'Firma Comercial',
      businessSignaturePlaceholder: 'Texto de cierre opcional o firma para sus facturas...',
      businessSignatureDesc: 'Texto personalizado que aparecerá al final de sus facturas',
      saving: 'Guardando...',
