const translations = {
  ...
  invoices: {
    ...
    settingsForm: {
      ...
      paymentAndInvoice: 'Payment & Invoice Settings',
      paymentTermsDays: 'Payment Terms (Days)',
      paymentTermsDaysDesc: 'Number of days for payment terms (default: 14 days)',
      invoiceNumberPrefix: 'Invoice Number Prefix',
      invoiceNumberPrefixPlaceholder: 'e.g., INV-2024-',
      invoiceNumberPrefixDesc: 'Optional prefix for your invoice numbers (e.g., INV-2024-001)',
      businessSignature: 'Business Signature',
      businessSignaturePlaceholder: 'Optional closing text or signature for your invoices...',
      businessSignatureDesc: 'Custom text that will appear at the bottom of your invoices',
      saving: 'Saving...',
